...
# Rutas de base de datos dinámica en el mismo directorio del script
...
def seed_data(conn):
    """Inserta datos de ejemplo la primera vez para pruebas inmediatas."""
    cur = conn.cursor()

    # Usuario del sistema
    cur.execute(
        "INSERT INTO sistema_usuarios (usuario, password) VALUES ('admin','admin123')"
    )
...
def init_db():
    """Crea las tablas si no existen y siembra datos la primera vez."""
